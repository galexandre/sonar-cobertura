...
plugin)
  ...
  cd its/$TEST
  mvn package -B -Dsonar.runtimeVersion="$SQ_VERSION" -Dsonar.updatecenter.url=http://update.sonarsource.org/update-center.properties -DjavaVersion="LATEST_RELEASE" -Dmaven.test.redirectTestOutputToFile=false
  ;;
